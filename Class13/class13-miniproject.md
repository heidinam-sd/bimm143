...
Q1: Complete the code below to remove the troublesome first column of
`countData`
...
Making a plot of log2 fold change vs -log adjusted p-value:

``` r
plot( res$log2FoldChange, -log(res$padj) )
```

![](class13-miniproject_files/figure-commonmark/unnamed-chunk-10-1.png)
...
![](class13-miniproject_files/figure-commonmark/unnamed-chunk-11-1.png)
...
installing code for bioconductor packages:
...
bringing the data from our `mapIDs()` function:
...
checking the `gage` analysis data:
...
Trying out the `pathview` package:
...
```
    ...
    Info: Working in directory C:/Users/reein/Desktop/UCSD/SP23/BIMM143/bimm143/Class13

    Info: Writing image file hsa04110.pathview.png

![](hsa04110.pathview.png)

Pulling out the top 5 upregulated pathways:
...
``` r
# drawing plots of the 5 pathways
...
doing a similar procedure with gene ontology:
...
A: The most significant “Entities p-value” pathway was Cell Cycle,
Mitotic. This was different from our KEGG results as the most
significant pathway was Cell Cycle, however it was deemed as second
highest from the Reactome analysis. This could be caused by the
difference in databases as they are independent from each other, and it
could also be caused by the different math methods to identify the
p-value
